...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Parametrizar tipos y restricciones de persona. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Parametrizar tipos y restricciones de persona |
| Id. Requerimiento | MT-EP01-HU19 |
| Id asociado | REQ-MT-19 / EP-01 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de parametrización (o administrador de empresa con ese permiso), quiero definir tipos de restricción y registrar restricciones por persona con alcance, vigencia y efecto, para respetar limitaciones individuales sin categorías quemadas.
...
1. El usuario entra a la función de parametrizar tipos y restricciones de persona.
...
4. Cuando crea un tipo de restricción.
   - Sistema: Entonces queda disponible para usar en restricciones.

Resultado esperado: Parametrizar tipos y restricciones de persona queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Parametrizar tipos y restricciones de persona» dentro del módulo Malla de Turnos.
...
1. Tipo: dado que parametrizador, cuando crea un tipo de restricción, entonces queda disponible para usar en restricciones.
2. Restricción: dado que persona con restricción vigente que bloquea un turno, cuando se intenta asignar ese turno, entonces se aplica el efecto configurado.
3. Vigencia: dado que restricción vencida, cuando se asigna, entonces no aplica.
4. Tenant: dado que persona de otra empresa, cuando alta restricción, entonces imposible.
...
- RN-01: Los tipos son catálogo tenant-scoped.
- RN-02: El motor de asignación/rotación consume restricciones (HU55).
- RN-03: Efecto bloquear impide guardar; advertir permite con confirmación según severidad.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Código del tipo de restricción | 40 | Alfanumérico | SI | NO | SI | Identificador del tipo |
| Nombre del tipo | 120 | Alfanumérico | SI | NO | SI | Nombre visible |
| Funcionario | N/A | Selección | SI | SI | SI | Persona a la que aplica la restricción |
| Tipo de restricción | N/A | Selección | SI | SI | SI | Tipo parametrizado |
| Fecha desde | 10 | Fecha | SI | NO | SI | Inicio de la restricción |
| Fecha hasta | 10 | Fecha | NO | NO | SI | Fin de la restricción |
| Observación | N/A | Texto | NO | NO | SI | Detalle de la restricción |
| Activo | 1 | Booleano | SI | NO | SI | Indica si la restricción está vigente |
