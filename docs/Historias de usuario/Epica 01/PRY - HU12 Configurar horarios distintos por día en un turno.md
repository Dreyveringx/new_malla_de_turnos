...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Configurar horarios distintos por día en un turno. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Configurar horarios distintos por día en un turno |
| Id. Requerimiento | MT-EP01-HU12 |
| Id asociado | REQ-MT-12 / EP-01 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de parametrización (o administrador de empresa con ese permiso), quiero definir para una plantilla horarios diferentes según día de la semana u otros criterios de día configurables, para representar turnos que no tienen el mismo horario todos los días.
...
1. El usuario entra a la función de configurar horarios distintos por día en un turno.
...
4. Cuando se define horario distinto para un día de la semana.
   - Sistema: Entonces al asignar ese día se usa la variante.

Resultado esperado: Configurar horarios distintos por día en un turno queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Configurar horarios distintos por día en un turno» dentro del módulo Malla de Turnos.
...
1. Variante: dado que existe una plantilla, cuando se define horario distinto para un día de la semana, entonces al asignar ese día se usa la variante.
2. Default: dado que no hay variante para el día, cuando se asigna la plantilla, entonces usa horario base.
3. Permisos: dado que usuario sin ACTUALIZAR en Parametrización, cuando intenta editar variantes, entonces se niega.
4. Tenant: dado que plantilla de otra empresa, cuando intenta editar, entonces no accesible.
...
- RN-01: Si no hay variante para un día, aplica el horario base de la plantilla.
- RN-02: Las variantes pertenecen a la misma empresa que la plantilla.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Plantilla de turno | N/A | Selección | SI | SI | SI | Plantilla a la que aplica el horario |
| Día de la semana | 1 | Selección | SI | NO | SI | Día (0–6) con horario distinto |
| Hora inicio | 8 | Hora | SI | NO | SI | Inicio para ese día |
| Hora fin | 8 | Hora | SI | NO | SI | Fin para ese día |
| Cruza medianoche | 1 | Booleano | SI | NO | SI | Indica cruce de medianoche ese día |
