...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Parametrizar plantilla de importación de novedades TH. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Parametrizar plantilla de importación de novedades TH |
| Id. Requerimiento | MT-EP08-HU74 |
| Id asociado | REQ-MT-74 / EP-08 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de parametrización, quiero definir el mapeo de columnas de un archivo de novedades TH a estados y personas, para cruzar información externa sin rigidizar un formato único en código.
...
1. El usuario entra a la función de parametrizar plantilla de importación de novedades th.
...
4. Cuando guarda plantilla.
   - Sistema: Entonces queda activa para la empresa.

Resultado esperado: Parametrizar plantilla de importación de novedades TH queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Parametrizar plantilla de importación de novedades TH» dentro del módulo Malla de Turnos.
...
1. Mapeo: dado que define columnas, cuando guarda plantilla, entonces queda activa para la empresa.
2. Validación: dado que archivo sin columna obligatoria, cuando importa, entonces rechaza con error claro.
3. Tenant: dado que plantilla, cuando propia, entonces OK.
4. Extensible: dado que nueva columna, cuando se agrega al mapeo, entonces sin deploy de regla fija.
...
- RN-01: Plantilla parametrizable; seeds de ejemplo opcionales.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Nombre de plantilla | 120 | Alfanumérico | SI | NO | SI | Nombre de la plantilla de importación TH |
| Columnas esperadas | N/A | Texto | SI | NO | SI | Definición de columnas del archivo |
| Separador / formato | 20 | Selección | SI | NO | SI | Formato del archivo de entrada |
| Activo | 1 | Booleano | SI | NO | SI | Indica si la plantilla está vigente |
