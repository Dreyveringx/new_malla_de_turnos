...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Cruzar programación con novedades TH importadas. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Cruzar programación con novedades TH importadas |
| Id. Requerimiento | MT-EP08-HU75 |
| Id asociado | REQ-MT-75 / EP-08 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de reportes, quiero cruzar la malla con un archivo de novedades importado según la plantilla y producir diferencias, para detectar inconsistencias entre operación y TH.
...
1. El usuario entra a la función de cruzar programación con novedades th importadas.
...
4. Cuando ejecuta.
   - Sistema: Entonces lista coincidencias/diferencias.

Resultado esperado: Cruzar programación con novedades TH importadas queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Cruzar programación con novedades TH importadas» dentro del módulo Malla de Turnos.
...
1. Cruce: dado que archivo válido y malla, cuando ejecuta, entonces lista coincidencias/diferencias.
2. Aplicar: dado que confirma diferencias, cuando aplica, entonces celdas actualizadas + historial.
3. Error formato: dado que archivo inválido, cuando rechaza, entonces sin cambios.
...
- RN-01: Cruce no borra historial.
- RN-02: Aplicar cambios exige permiso y deja origen=import.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Archivo de novedades TH | N/A | Archivo | SI | NO | SI | Archivo según plantilla parametrizada |
| Periodo a cruzar | N/A | Selección | SI | NO | SI | Periodo de programación a contrastar |
| Frente operativo | N/A | Selección | SI | SI | SI | Alcance del cruce |
