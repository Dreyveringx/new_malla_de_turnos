...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Ajustar manualmente tras rotación o sugerencia. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Ajustar manualmente tras rotación o sugerencia |
| Id. Requerimiento | MT-EP03-HU56 |
| Id asociado | REQ-MT-56 / EP-03 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla, quiero modificar celdas después de una aplicación automática/asistida, dejando trazabilidad de origen manual, para permitir excepciones humanas controladas.
...
1. El usuario entra a la función de ajustar manualmente tras rotación o sugerencia.
...
4. Cuando cambia turno.
   - Sistema: Entonces origen pasa a manual y hay historial.

Resultado esperado: Ajustar manualmente tras rotación o sugerencia queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Ajustar manualmente tras rotación o sugerencia» dentro del módulo Malla de Turnos.
...
1. Ajuste: dado que celda origen automático, cuando cambia turno, entonces origen pasa a manual y hay historial.
2. Regla: dado que ajuste inválido, cuando guarda, entonces aplica severidad.
3. Publicada: dado que editabilidad off, cuando intenta, entonces niega o exige flujo HU59.
...
- RN-01: El ajuste manual revalida reglas.
- RN-02: Si la malla está publicada, aplican políticas HU59.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Celda a ajustar | N/A | Selección | SI | SI | SI | Celda tras rotación o sugerencia |
| Nuevo turno o estado | N/A | Selección | SI | SI | SI | Ajuste manual |
| Motivo del ajuste | N/A | Texto | NO | NO | SI | Justificación del cambio manual |
