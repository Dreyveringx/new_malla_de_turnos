...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Excluir personas o celdas de la rotación. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Excluir personas o celdas de la rotación |
| Id. Requerimiento | MT-EP03-HU49 |
| Id asociado | REQ-MT-49 / EP-03 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla, quiero marcar personas o celdas concretas para que la rotación asistida/automática no las modifique, para proteger excepciones operativas.
...
1. El usuario entra a la función de excluir personas o celdas de la rotación.
...
4. Cuando marca exclusión.
   - Sistema: Entonces simulación no la altera.

Resultado esperado: Excluir personas o celdas de la rotación queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Excluir personas o celdas de la rotación» dentro del módulo Malla de Turnos.
...
1. Excluir persona: dado que grupo vinculado, cuando marca exclusión, entonces simulación no la altera.
2. Excluir celda: dado que día específico, cuando excluye, entonces propuesta la omite.
3. Quitar exclusión: dado que había exclusión, cuando quita, entonces vuelve a participar.
4. Tenant: dado que exclusión, cuando propia empresa, entonces OK.
...
- RN-01: Las exclusiones son tenant-scoped y auditables.
- RN-02: Celdas excluidas conservan su valor actual al aplicar.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Vinculación patrón-grupo | N/A | Selección | SI | SI | SI | Rotación en curso |
| Funcionario excluido | N/A | Selección | NO | SI | SI | Persona fuera de la rotación |
| Celda excluida | N/A | Selección | NO | SI | SI | Celda concreta fuera de la rotación |
| Motivo de exclusión | N/A | Texto | NO | NO | SI | Justificación opcional |
