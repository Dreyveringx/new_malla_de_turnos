...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Aplicar restricciones y motor de reglas al rotar o asignar. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Aplicar restricciones y motor de reglas al rotar o asignar |
| Id. Requerimiento | MT-EP03-HU55 |
| Id asociado | REQ-MT-55 / EP-03 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla, quiero que toda asignación manual, asistida o automática pase por restricciones de persona y reglas del frente, para impedir propuestas inválidas.
...
1. El usuario entra a la función de aplicar restricciones y motor de reglas al rotar o asignar.
...
4. Cuando asigna o simula.
   - Sistema: Entonces no propone/guarda ese turno.

Resultado esperado: Aplicar restricciones y motor de reglas al rotar o asignar queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Aplicar restricciones y motor de reglas al rotar o asignar» dentro del módulo Malla de Turnos.
...
1. Bloqueo: dado que restricción vigente incompatible, cuando asigna o simula, entonces no propone/guarda ese turno.
2. Rotación: dado que patrón caería en turno prohibido, cuando simula, entonces marca conflicto o excluye.
3. Manual: dado que mismo control, cuando guarda celda, entonces idéntica evaluación.
4. Tenant: dado que restricción ajena, cuando no aplica, entonces OK.
...
- RN-01: Bloqueo de restricción impide propuesta/guardado.
- RN-02: Advertencia requiere confirmación cuando la UI lo permita.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Malla o acción de rotación | N/A | Selección | SI | SI | SI | Contexto donde se evalúan las reglas |
| Confirmar pese a advertencias | 1 | Booleano | NO | NO | SI | Solo si la severidad lo permite |
