...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Visualizar equilibrio de turnos por persona. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Visualizar equilibrio de turnos por persona |
| Id. Requerimiento | MT-EP03-HU44 |
| Id asociado | REQ-MT-44 / EP-03 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla, quiero ver distribución de plantillas/estados por persona en el periodo según métricas configurables, para apoyar decisiones de equidad sin umbrales quemados.
...
1. El usuario entra a la función de visualizar equilibrio de turnos por persona.
...
4. Cuando abre equilibrio.
   - Sistema: Entonces lista métricas por persona.

Resultado esperado: Visualizar equilibrio de turnos por persona queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Visualizar equilibrio de turnos por persona» dentro del módulo Malla de Turnos.
...
1. Vista: dado que malla con asignaciones, cuando abre equilibrio, entonces lista métricas por persona.
2. Regla: dado que se supera umbral configurado, cuando evalúa, entonces marca hallazgo con severidad.
3. Permisos: dado que LEER, cuando consulta, entonces permitido.
4. Tenant: dado que datos, cuando aislados, entonces OK.
...
- RN-01: Los umbrales de desequilibrio son reglas parametrizables (advertencia/bloqueo).
- RN-02: No existe una métrica única hardcodeada por frente.
