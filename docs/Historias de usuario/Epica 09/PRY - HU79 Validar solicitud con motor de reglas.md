...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Validar solicitud con motor de reglas. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Validar solicitud con motor de reglas |
| Id. Requerimiento | MT-EP09-HU79 |
| Id asociado | REQ-MT-79 / EP-09 |

### Descripción de historia de usuario

Como Usuario de la empresa vinculado a un funcionario, quiero que el sistema valide anticipación, solape, cobertura, horas, restricciones y demás reglas al crear o aprobar, para evitar intercambios que rompan la operación.
...
1. El usuario entra a la función de validar solicitud con motor de reglas.
...
4. Cuando crea.
   - Sistema: Entonces rechaza con motivos.

Resultado esperado: Validar solicitud con motor de reglas queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Validar solicitud con motor de reglas» dentro del módulo Malla de Turnos.
...
1. Creación inválida: dado que viola bloqueo, cuando crea, entonces rechaza con motivos.
2. Advertencia: dado que severidad advertencia, cuando crea, entonces queda pendiente con warnings visibles al aprobador.
3. Revalidar: dado que entre creación y aprobación cambió malla, cuando aprueba, entonces revalida y puede fallar.
...
- RN-01: Solape real = bloqueo.
- RN-02: Resto según HU25 + config HU77.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Solicitud de intercambio | N/A | Selección | SI | SI | SI | Solicitud a validar con el motor |
