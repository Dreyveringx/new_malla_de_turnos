...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Aprobar o rechazar solicitud de intercambio. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Aprobar o rechazar solicitud de intercambio |
| Id. Requerimiento | MT-EP09-HU80 |
| Id asociado | REQ-MT-80 / EP-09 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla, quiero aprobar o rechazar solicitudes pendientes según la configuración de aprobadores, para gobernar el cambio con responsabilidad clara.
...
1. El usuario entra a la función de aprobar o rechazar solicitud de intercambio.
...
4. Cuando aprueba.
   - Sistema: Entonces pasa a aprobada pendiente de aplicación o aplica según diseño.

Resultado esperado: Aprobar o rechazar solicitud de intercambio queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Aprobar o rechazar solicitud de intercambio» dentro del módulo Malla de Turnos.
...
1. Aprobar: dado que solicitud válida y usuario aprobador, cuando aprueba, entonces pasa a aprobada pendiente de aplicación o aplica según diseño.
2. Rechazar: dado que con motivo, cuando rechaza, entonces malla intacta + notificación.
3. No aprobador: dado que usuario sin permiso, cuando intenta, entonces niega.
4. Revalidación: dado que ya no es válida, cuando aprueba, entonces falla con motivos.
...
- RN-01: Quién aprueba lo define HU77 + permisos, no un rol quemado.
- RN-02: Rechazo no cambia malla.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Solicitud de intercambio | N/A | Selección | SI | SI | SI | Solicitud pendiente |
| Decisión | 20 | Selección | SI | NO | SI | Aprobar o rechazar |
| Motivo de rechazo | N/A | Texto | NO | NO | SI | Obligatorio si se rechaza |
