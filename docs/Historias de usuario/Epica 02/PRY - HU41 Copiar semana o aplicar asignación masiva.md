...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Copiar semana o aplicar asignación masiva. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Copiar semana o aplicar asignación masiva |
| Id. Requerimiento | MT-EP02-HU41 |
| Id asociado | REQ-MT-41 / EP-02 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla, quiero copiar un rango de fechas o aplicar la misma asignación a varias celdas, para armar el periodo más rápido sin saltarme validaciones.
...
1. El usuario entra a la función de copiar semana o aplicar asignación masiva.
...
Resultado esperado: Copiar semana o aplicar asignación masiva queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Copiar semana o aplicar asignación masiva» dentro del módulo Malla de Turnos.
...
- RN-01: Origen y destino pertenecen a la misma empresa y malla/frente autorizados.
- RN-02: Los bloqueos del motor de reglas no se aplican; se reportan.
- RN-03: Queda historial en celdas modificadas.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Malla destino | N/A | Selección | SI | SI | SI | Malla donde se aplica la copia |
| Semana / rango origen | N/A | Selección | SI | NO | SI | Periodo origen a copiar |
| Semana / rango destino | N/A | Selección | SI | NO | SI | Periodo destino |
| Personas incluidas | N/A | Selección | NO | SI | SI | Subset opcional de filas |
| Confirmar sobrescritura | 1 | Booleano | SI | NO | SI | Confirma reemplazo de celdas existentes |
