...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Filtrar y buscar en la grilla por atributos habilitados. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Filtrar y buscar en la grilla por atributos habilitados |
| Id. Requerimiento | MT-EP02-HU38 |
| Id asociado | REQ-MT-38 / EP-02 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla (coordinador/supervisora según rol), quiero filtrar la grilla por texto, turno, estado y atributos habilitados del frente, para encontrar rápido personas o situaciones.
...
1. El usuario entra a la función de filtrar y buscar en la grilla por atributos habilitados.
...
4. Cuando filtra uno.
   - Sistema: Entonces solo filas/celdas coincidentes en la ventana.

Resultado esperado: Filtrar y buscar en la grilla por atributos habilitados queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Filtrar y buscar en la grilla por atributos habilitados» dentro del módulo Malla de Turnos.
...
1. Filtro estado: dado que hay varios estados, cuando filtra uno, entonces solo filas/celdas coincidentes en la ventana.
2. Sin filtro fantasma: dado que territorio off, cuando abre filtros, entonces no aparece filtro territorio.
3. Permisos: dado que LEER, cuando filtra, entonces permitido.
4. Tenant: dado que datos, cuando filtro, entonces solo propia empresa.
...
- RN-01: No mostrar filtros de capacidades deshabilitadas.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Texto de búsqueda | 120 | Alfanumérico | NO | NO | SI | Nombre u otro criterio de búsqueda |
| Filtro por turno | N/A | Selección | NO | SI | SI | Filtra celdas por plantilla |
| Filtro por estado | N/A | Selección | NO | SI | SI | Filtra celdas por estado |
| Filtro por atributo habilitado | N/A | Selección | NO | SI | SI | Sitio, modalidad, territorio, campaña, etc. |
