...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Asignar segundo turno o turno extra el mismo día. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Asignar segundo turno o turno extra el mismo día |
| Id. Requerimiento | MT-EP02-HU31 |
| Id asociado | REQ-MT-31 / EP-02 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla (coordinador/supervisora según rol), quiero agregar un segundo turno el mismo día cuando la capacidad del frente lo permite, para cubrir jornadas partidas o extras operativas.
...
1. El usuario entra a la función de asignar segundo turno o turno extra el mismo día.
...
4. Cuando agrega segundo turno.
   - Sistema: Entonces ambos quedan registrados.

Resultado esperado: Asignar segundo turno o turno extra el mismo día queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Asignar segundo turno o turno extra el mismo día» dentro del módulo Malla de Turnos.
...
1. Alta segundo: dado que capacidad on y sin solape, cuando agrega segundo turno, entonces ambos quedan registrados.
2. Solape: dado que horarios se cruzan, cuando guarda, entonces bloquea.
3. Capacidad off: dado que flag off, cuando intenta segundo turno, entonces no disponible.
4. Reglas horas: dado que supera max_hours_period, cuando guarda, entonces aplica severidad regla.
...
- RN-01: Solo si HU26 habilita doble turno.
- RN-02: Solape real sigue siendo bloqueo.
- RN-03: Marca de extra si el catálogo/regla lo define.
...
| ----- | -------- | ---- | ----------- | ------- | -------- | ----------- |
| Celda (persona y fecha) | N/A | Selección | SI | SI | SI | Día donde se agrega el segundo turno |
| Slot / turno adicional | 2 | Número | SI | NO | SI | Número de slot (>0) del turno extra |
| Plantilla de turno | N/A | Selección | SI | SI | SI | Turno del slot adicional |
