...
| ----- | ------- | ----------- | ----- |
| 05/09/2026 | 1.0 | Asignar campaña o tarea a la celda. | Jair Uribe |
...
| Campo | Valor |
| ----- | ----- |
| Nombre historia de usuario | Asignar campaña o tarea a la celda |
| Id. Requerimiento | MT-EP02-HU36 |
| Id asociado | REQ-MT-36 / EP-02 |

### Descripción de historia de usuario

Como Usuario de la empresa con permiso de construcción de malla (coordinador/supervisora según rol), quiero etiquetar la celda con campaña/tarea si la capacidad está activa, para reflejar la actividad operativa del día.
...
1. El usuario entra a la función de asignar campaña o tarea a la celda.
...
4. Cuando asigna campaña vigente.
   - Sistema: Entonces persiste.

Resultado esperado: Asignar campaña o tarea a la celda queda operativa, aislada por empresa y gobernada por configuración.
...
Pantalla o flujo de «Asignar campaña o tarea a la celda» dentro del módulo Malla de Turnos.
...
1. OK: dado que capacidad on, cuando asigna campaña vigente, entonces persiste.
2. Off: dado que capacidad off, cuando campo ausente, entonces OK.
3. No vigente: dado que campaña vencida, cuando asigna, entonces rechaza.
4. Tenant: dado que campaña ajena, cuando rechaza, entonces OK.
...
- RN-01: Solo campañas vigentes y del frente/empresa.
...
| Campaña o tarea | N/A | Selección | SI | SI | SI | Campaña/tarea asignada |
