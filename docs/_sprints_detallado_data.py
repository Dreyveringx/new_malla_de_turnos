# -*- coding: utf-8 -*-
"""Datos de sprints detallados (actividades con HU). Importado por _gen_backlog_sprints_detallado.py."""
...
SPRINTS: list[dict] = [
    {
        ...
        "objetivo": (
            "Dejar el módulo usable en menú/permisos/tenant y parametrizar frentes, turnos, "
            "estados, campañas, territorio, modalidades y sitios."
        ),
        "hu": "HU01–HU18",
        "hu_list": "HU01–HU08 (integración) + HU09–HU18 (catálogos núcleo)",
        "rows": [
    ...
    },
    {
        ...
        "objetivo": (
            "Cerrar parametrización avanzada: restricciones, cortes, tipos de hora, cobertura, "
            "compensatorio, motor de validación, flags de celda e import Excel asistida."
        ),
        "hu": "HU19–HU27",
    ...
    },
    {
        ...
        "objetivo": (
            "Crear malla por periodo/frente, seleccionar personas y asignar turno/estado/"
            "extra/territorio/modalidad-sitio/nota sobre grilla operativa."
        ),
        "hu": "HU28–HU35",
    ...
    },
    {
        ...
        "objetivo": (
            ...
            "copia masiva y fijar atributos por periodo."
        ),
        "hu": "HU36–HU42",
    ...
    },
    {
        ...
        "objetivo": (
            "Indicadores de cobertura/equilibrio, conflictos en grilla, patrones de rotación, "
            "simulación, exclusiones y aplicación a la malla."
        ),
        "hu": "HU43–HU50",
    ...
    },
    {
        ...
        "objetivo": (
            ...
            "ajuste manual y ciclo de publicación (revisión/rechazo/edición publicada)."
        ),
        "hu": "HU51–HU59",
    ...
    },
    {
        ...
        "objetivo": (
            "Novedades en celda, responsable de novedad (MVP), historial inmutable, notificaciones; "
            "consulta quién está disponible; vistas de empleado (grupo/propia/historial)."
        ),
        "hu": "HU60–HU69",
    ...
    },
    {
        ...
        "objetivo": (
            "Calcular horas por tipo, exportar malla/cobertura, cruzar novedades TH "
            "y aplicar compensatorio en reporte (sin liquidar pesos)."
        ),
        "hu": "HU70–HU76",
    ...
    },
    {
        ...
        "objetivo": (
            "Configurar intercambio por frente, solicitar, validar con reglas, aprobar/rechazar, "
            "aplicar con auditoría/notificación; estabilizar para piloto."
        ),
        "hu": "HU77–HU81",
